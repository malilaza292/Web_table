          ...
          <div class="register-form">
            <form method="post" action="includes/register.inc.php">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="SetupDate" class="form-control" id="SetupDate" autocomplete="on" value="00/00/00" data-date-format="dd/mm/yy" id="dp2">
              </div>
              <div class="mb-3">
                <label for="CaliDate" class="form-label">วันที่สอบเทียบ</label>
                <input type="text" name="CaliDate" class="form-control" id="CaliDate" autocomplete="on" value="00/00/00" data-date-format="dd/mm/yy" id="dp2">
              </div>
              <div class="mb-3">
                <label for="NextCal" class="form-label">วันที่สอบเทียบครั้งต่อไป</label>
                <input type="text" name="NextCal" class="form-control" id="NextCal" autocomplete="on" value="00/00/00" data-date-format="dd/mm/yy" id="dp2">
              </div>
              <div class="mb-3">
